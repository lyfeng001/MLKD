...
def main():
    ...
    # for window in np.linspace(0.25,0.55,30):
    for lr in np.linspace(0.25,0.35,20):
        ...
        for v_idx, video in enumerate(dataset):
            ...
            for idx, (img, gt_bbox) in enumerate(video):
                ...
                if idx == 0:
                    ...
                    tracker.init(img, gt_bbox_, 0.14, 0.40, lr)
                    pred_bbox = gt_bbox_
                    scores.append(None)
            ...
            model_path = os.path.join('results', args.dataset, model_name, '0.14'+'_'+'0.40'+'_'+str(lr))
