...
class ModelBuilder(nn.Module):
    def __init__(self,option,multi_stu=False, stu_num=None):
    ...
    ########################################
            ...
            outputs['cls'] = clsss
            outputs['cls_feature'] = cls_feature
          

            if multi_stu==False:
                if self.stu_num == 1:
                    outputs['corr_loss'] = corr_loss1
                    outputs['total_loss'] += corr_loss1
                elif self.stu_num == 2:
                    outputs['corr_loss'] = corr_loss2
                    outputs['total_loss'] += corr_loss2
                elif self.stu_num == 3:
                    outputs['corr_loss'] = corr_loss3
                    outputs['total_loss'] += corr_loss3
